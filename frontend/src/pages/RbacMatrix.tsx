...
const GROUPS: { name: string; prefix: string; description: string }[] = [
  ...
  { name: 'Inventory', prefix: 'inventory.', description: 'Item catalog, stock, spending' },
  { name: 'Suppliers', prefix: 'suppliers.', description: 'Vendor master data and purchase history' },
